...
public class ServiceElectrodomestico {
    ...
    public Integer precioFinalLavadora(){
        Integer pl;
        elec.precioFinal();
        if(lav.getCarga()>30){
    ...
    public Integer precioFinalTelevisor(){
        Integer p;
        elec.precioFinal();
    ...
    public Integer precioTotalLavadoras(){
        
        precioTotalL += elec.getPrecio();
        return precioTotalL;
    }
    public Integer precioTotalTelevisores(){
        
        precioTotalTV += elec.getPrecio();
        return precioTotalTV;
    }
